...
(
    ...
    review_title      VARCHAR(20)   NOT NULL
        CONSTRAINT book_review_itle CHECK (review_title != ""),
    id                         BIGINT        NOT NULL AUTO_INCREMENT,
    book_id                    BIGINT        NULL,
...
(
    ...
    score_value                INTEGER NOT NULL DEFAULT 0
        CONSTRAINT book_review_request_for_publication_criterion_score_score_value CHECK (score_value >= 0 AND score_value <= 10),
